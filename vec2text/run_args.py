...
DATASET_NAMES = [
    "xnli_ar", "xnli_bg", "xnli_de", "xnli_el", "xnli_es", "xnli_fr", "xnli_hi", "xnli_en",
    "xnli_ru", "xnli_sw", "xnli_th", "xnli_tr", "xnli_ur", "xnli_vi", "xnli_zh",
    "mtg", "mtg_zh", "mtg_de", "mtg_es", "mtg_en", "mtg_fr", "mtg_all", "mtg_5m", "mtg_7.5m", "mtg_zh_dummy",
    "mtg_en_fr_de_es_5m", "mtg_en_fr_de_es_5m_shuffled",
    # 20th December 2023
    "mtg_en_5m", "mtg_fr_5m", "mtg_de_5m", "mtg_zh_5m", "mtg_es_5m", "mtg_all_5m", "mtg_all_20m",
    "nq",
    "luar_reddit",
    "msmarco",
...
class ModelArguments:
    ...
    # added by Yiyi for correctorEncoder. check huggingface docs.
    embedder_dim: int = field(
        default=768,
        metadata={
            "help": "Dimensionality of the embedder model embeddings"
        },
    )
    ...
    noise_level: Optional[str] = field(
        default=0.,
        metadata={
            "help": "the level of noise to insert in the embeddings",
            "choices": NOISE_LEVELS,
        })

    defense_algo: Optional[str] = field(
        default="gaussian",
        metadata={
            "help": "the algorithm for defense ",
            "choices": DEFENSE_ALGOS
        }
    )

    doc_lang: Optional[str] = field(
        default="es",
        metadata={
            "help": "the language of the corpus data for retrieval",
            "choices": DOC_LANGS
        }
    )
